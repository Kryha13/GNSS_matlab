function [Ncom1] = CAR_nolambda(obs_types, time_interval)
const;
...
%         Lcom2 = (L2 - L3)*lam_com2;
        ...
        minus = [repmat(Ncom1, 2,1)- repmat(Ncom2, 2,1);...
            repmat(Ncom1, 1,1)];
        L = L - minus;
        L = [Ltrans1; L];
        DU = [DU2; DU];
