...
system = 'E';
data = ["2018-SEPT.mat" "2018-SEP2.mat"];

[X_code1, DOP1, dtrec1, Az_EL_R1] = codepos(X(1,:), codes, time_interval, system, data(1));
[X_code2, DOP2, dtrec2, Az_EL_R2] = codepos(X(2,:), codes, time_interval, system, data(2));
