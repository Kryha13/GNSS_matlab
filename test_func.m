function [x_fixed, x_float, ratio, N_fixed, N_float, mx, my, mz] = test_func(X1, X2, time_interval, comb, comb_err)
...
if length(comb)==4
    [phase, code] = combinations(comb);
elseif length(comb)==6
    [phase, code] = trans_comb(comb);
end
obs_types = [phase code]; % wybór obserwacji 
...
for i=1:length(epochs)
    ...
    if string(comb)=='com1'
        ...
        P1 = C7a - C5a;
        P2 = C7b - C5b;
    elseif string(comb)=='com2'
        L1 = L6a - L7a;
        L2 = L6b - L7b;
        P1 = C6a - C7a;
        P2 = C6b - C7b;
    elseif string(comb)=='com3'
        L1 = L1a - L6a;
        L2 = L1b - L6b;
        P1 = C1a - C6a;
        P2 = C1b - C6b;
    elseif string(comb)=='trans1'
        L1 = 5*L6a - L7a - 4*L5a;
        L2 = 5*L6b - L7b - 4*L5b;
        P1 = 5*C6a - C7a - 4*C5a;
        P2 = 5*C6b - C7b - 4*C5b;
    elseif string(comb)=='trans2'
        L1 = 5*L1a - 2*L7a - 3*L5a;
        L2 = 5*L1b - 2*L7b - 3*L5b;
        P1 = 5*C1a - 2*C7a - 3*C5a;
        L2 = 5*C1b - 2*C7b - 3*C5b;
    end
    
       
    % pojedyncze ró¿nice i macierze tworz¹ce podwójnych
    single_diff_C1 = (P1 - P2)';
